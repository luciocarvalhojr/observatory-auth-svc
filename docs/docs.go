...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/domain.IntrospectResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
    ...
    "definitions": {
        ...
        "domain.TokenResponse": {
            ...
            "properties": {
                "access_token": {
                    "description": "#nosec G117 -- intentional: this is the API response body, not a hardcoded secret",
                    "type": "string"
                },
                "expires_in": {
                    "description": "seconds",
